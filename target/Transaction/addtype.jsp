...
<section class="page-two">
    <div class="table_button">
        <span  id="mytype" class="btn btn-main" style="color: white;border-radius: 0;">
            增加类型
        </span>
    ...
    <div class="col-sm-7">
        <div class="type_table">
            <table style="width: 665px;" cellspacing="0" cellpadding="0" border="0" id="typetable">
    ...
    <div class="col-sm-5" id="inputbox">
        <div class="type_box">
