...
<nav class="top ">
    <div class="top_middle">
        ...
        <span class="pull-right">
            <a href="toorderbuyer">我的订单</a>
            <a href="tofavorite.action"><i class="fa fa-star-o" aria-hidden="true"></i>我的收藏</a>
        </span>
    </div>
</nav>
...
<div class="cartDiv">
    <div class="cartTitle">
        <span class="cartTitleName">
            <span><b>全部商品<s:property value="data.data.goodsNumber" /> </b></span> |
            <span><b>失效商品<s:property value="data.data.invalidNumber" /></b></span>
        </span>
