                ...
                <div class="content" >
                    <form action="addGoods.action" method="post" class="form-horizontal" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="goods.name" class="form-control" id="title" placeholder="品类/品牌型号" required/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="goods.price" id="price" placeholder="售价" required/>
                            </div>
                        </div>
                        <div class="form-group">
