        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="discuss-div">
                    <textarea readonly="readonly" id="commentContent" name="comment.content" class="discuss-input"
                              value=""></textarea>
                </div>
            </div>
    ...
    <s:iterator value="jsonObject.data" var="json">
        <div class="single">
            ...
            <div class="single-footer">
                <div class="col-sm-6">
                    <a href="towebsocket.action?uid=<s:property value="sellerid"/>"><i class="fa fa-commenting-o fa-lg"
                                                                                       aria-hidden="true"></i>&nbsp;联系卖家</a>
                </div>
                <div class="col-sm-6 " style="text-align: right;">
                    <s:if test="orderstatus==0">
                        <button class="text-button" onclick="toWebSocket('<s:property value="sellerid"/>')">提醒发货
                        </button>
                    ...
                    <s:elseif test="orderstatus==2">
                        <a href="" data-toggle="modal" data-target="#discuss">
                            ...
                            <button class="text-button" onclick="mydiscuss('<s:property value="goodsgid"/>','<s:property
                                    value="orderid"/>')">评论
                            </button>
                        </a>
                    ...
                    <s:else>
                        <a href="javascript:void(0);">
                            <button class="text-button" onclick="getComment('<s:property value="comment"/>')">查看评论
                            </button>
                        </a>
